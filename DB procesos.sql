...
CREATE OR REPLACE PROCEDURE INSCRITO(V_ID IN VARCHAR2)
AS
    CURSOR CR_INSCRITO (V_ID_ESTUDIANTE IN VARCHAR2)
    IS
...
BEGIN
    DBMS_OUTPUT.PUT_LINE('El alumno ' || ESTUDIANTE.NOMBRE || ' ' || ESTUDIANTE.APELLIDO || ' está inscrito en los cursos siguientes:');
